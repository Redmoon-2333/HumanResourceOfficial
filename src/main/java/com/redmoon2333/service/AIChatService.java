...
public class AIChatService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            格式要求（必须严格遵守）：
            1. 使用标准Markdown语法：
               - 标题使用##开头，如：##你好呀，我是人力资源中心的小助理
               - 列表项使用-开头，如：- 活动组织：从策划到执行全流程协助
               - 重要内容可以使用**加粗**
            2. 必须在不同内容块之间使用换行符：
               - 标题和内容之间换行
               - 列表项之间换行
            ...
            3. 输出示例：
               ...
               - 活动组织：从策划到执行全流程协助，帮你梳理关键节点
               - 团队协作：优化沟通方式，提升小组合作效率
               - 部门流程：完善工作交接与档案管理，让运转更顺畅
               ```
            4. 输出内容将直接用于Markdown渲染，不需要额外转义
            """;
    ...
    public Flux<String> chatStream(Integer userId, String message) {
        ...
        try {
            return qwenChatClient
                    ...
                    .content()
                    // 限制缓冲区大小，防止内存溢出
                    .limitRate(100)  // 限制请求速率，每次最多预取100个元素
    ...
    public Flux<String> chatWithRag(Integer userId, String message, boolean useRAG, boolean enableTools) {
        ...
        try {
            // 1. 检索相关文档
            List<com.redmoon2333.dto.RetrievedDocument> documents = 
