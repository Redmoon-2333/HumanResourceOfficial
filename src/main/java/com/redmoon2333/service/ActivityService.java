...
public class ActivityService {
    ...
    public ActivityImage updateActivityImage(Integer imageId, ActivityImage imageDetails) {
        ...
        try {
            // 检查图片是否存在
            ActivityImage existingImage = activityImageMapper.selectById(imageId);
            ...
            if (result > 0) {
                ...
                logger.error("活动图片更新失败：图片 ID={}", imageId);
    ...
    public String getImageUrlById(Integer imageId) {
        ...
        ActivityImage image = activityImageMapper.selectById(imageId);
        if (image == null) {
